  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-light mb-8 text-center">Organize Your Wardrobe</h1>
            ...
            <Card className="rounded-none border-2 border-dashed">
              <CardContent className="flex flex-col items-center justify-center p-12 min-h-[300px]">
                ...
                <p className="text-center text-muted-foreground mb-6 max-w-md">
                  We'll scan your email for purchase receipts to automatically catalog your wardrobe.
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="rounded-none">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground text-sm">JACQUES • $465</p>
                </CardContent>
              </Card>
              <Card className="rounded-none">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground text-sm">JACQUES • $565</p>
                </CardContent>
              </Card>
            </div>
          </TabsContent>
